...
def st_ui():
    ...
    with st.spinner("Loading content image.."):
        if image_upload1 is not None:
            ...
            original_image = load_image("http://raw.githubusercontent.com/RadientBrain/Neural-Style-Transfer---Streamlit/main/1.jpg")
    ...
    with st.spinner("Loading style image.."):
        if image_upload2 is not None:
            ...
            style_image = load_image("http://raw.githubusercontent.com/RadientBrain/Neural-Style-Transfer---Streamlit/main/2.jpg")
            style_image = tf.nn.avg_pool(style_image, ksize=[3,3], strides=[1,1], padding='VALID')
